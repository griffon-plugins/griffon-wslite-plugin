...
----
dependencies {
    griffon '{project-group}:griffon-wslite-plugin:{project-version}'
}
----
...
----
dependencies {
    compile '{project-group}:griffon-wslite-core:{project-version}'
}
----
...
----
dependencies {
    compileOnly '{project-group}:griffon-wslite-groovy-compile:{project-version}'
}
----

== Maven

First configure the `griffon-wslite-plugin` BOM in your POM file, by placing the following
