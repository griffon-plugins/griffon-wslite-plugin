...
----
dependencies {
    griffon '{groupId}:griffon-wslite-plugin:{project-version}'
}
----
...
----
dependencies {
    compile '{groupId}:griffon-wslite-core:{project-version}'
}
----
...
----
dependencies {
    compileOnly '{groupId}:griffon-wslite-groovy-compile:{project-version}'
}
----
